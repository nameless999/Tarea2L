public class Enemigo_Contra_Reloj extends Enemigo_Circular {

    public Enemigo_Contra_Reloj(char tipo, int maxmov, int pasos, char direccion, int x, int y, char nombre) {
